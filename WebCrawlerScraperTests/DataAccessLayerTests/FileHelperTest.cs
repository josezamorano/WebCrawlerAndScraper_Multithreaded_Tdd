...
using Xunit;
namespace WebCrawlerScraperTests.DataAccessLayerTests
{
    public class FileHelperTest
    {
        ...
        public void CreateUniqueFileName_InputSameDataReturnsDifferentName()
        {
            ...
            //Act
            var actualResult1 = _fileHelper.CreateUniqueName(initialFileName, WebCrawlerScraper.Utils.Enumerations.FileExtension.txt);
            var actualResult2= _fileHelper.CreateUniqueName(initialFileName, WebCrawlerScraper.Utils.Enumerations.FileExtension.txt);
        ...
        {
            //Act
            var actualResult = _fileHelper.CreateUniqueName(originalName, WebCrawlerScraper.Utils.Enumerations.FileExtension.txt);
            //Assert
        ...
        public void ConvertCsvDataPropertiesTostring_ValidInputs_ReturnsOk()
        {
            ...
            CsvDataFormat csvDataFormat = new CsvDataFormat()
            {
                ...
                LinkStatus = WebCrawlerScraper.Utils.Enumerations.LinkStatus.Found_ForValidation,
                IsLinkFullyQualified = false,
                Level = 2,
                OriginalLink = "http://test.com",
                ParentPageUrl = "http://testParent.com",
                SavedFullFileName = "test",
                WebSitePageStatus = WebCrawlerScraper.Utils.Enumerations.WebSitePageStatus.NotDownloaded
            };
            //Act
